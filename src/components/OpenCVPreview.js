    ...
    <div className="col-span-full">
      <div className="grid grid-cols-2 gap-4">
        <Card>
          <div className="flex flex-col">
            <div className="flex items-center justify-center">
              <h2 className="my-4 font-semibold text-xl tracking-tight text-center">Draw Preview</h2>
              <InfoTooltip 
                id="drawToolTip"
        ...
        <Card>
          <div className="flex flex-col">
          <div className="flex items-center justify-center">
              <h2 className="my-4 font-semibold text-xl tracking-tight text-center">Removed Background Preview</h2>
              <InfoTooltip
        ...
        <Card>
          <div className="flex flex-col">
            <div className="flex items-center justify-center">
              <h2 className="my-4 font-semibold text-xl tracking-tight text-center">Threshold Preview</h2>
              <InfoTooltip
                id="thresholdToolTip"
        ...
        <Card>
          <div className="flex flex-col">
            <div className="flex items-center justify-center">
              <h2 className="my-4 font-semibold text-xl tracking-tight text-center">Contour Preview</h2>
              <InfoTooltip
                id="contourToolTip"
